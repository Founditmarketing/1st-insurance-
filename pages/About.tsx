...
const About: React.FC = () => {
   return (
      <div className="pt-20">
         <SEO
            title="About Us"
            description="Meet the local team at 1st Insurance Marksville. We've been serving Avoyelles Parish since 1985 with integrity and a handshake you can trust."
            canonical="/about"
         />
